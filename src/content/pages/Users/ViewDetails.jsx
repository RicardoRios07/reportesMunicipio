...
const ViewDetails = ({ primaryAction, userSelected }) => {
        ...
        <Grid container justifyContent='center' >
                    ...
                    userSelected?.photo
                        ...
                        <svg viewBox="0 0 100 100"
                            style={{
                                ...
                                borderRadius: '50%',
                                border: '6px solid white',
                                backgroundImage: 'linear-gradient(-60deg, hwb(64 18% 5%) 0%, #13a51a 100%)',
                                top: '25px',
                                left: '25%',
                                zIndex: ' 2'
                            }}>
            ...
            <Grid item sx={12} md={4} >
                <div style={{
                    ...
                    backgroundImage: 'url("../../public/static/img/collage_Puyango.jpg")',
            ...
            <Grid item container xs={12} md={7} direction='column' >
                <Typography paddingLeft={3} variant='h3'>{userSelected.nombreCompleto}</Typography>
                <Grid item alignItems={'center'} display='flex' direction='column'>
                    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}
                        ...
                        <ListItem>
                            ...
                            <ListItemText primary={userSelected.cedula} />
                        </ListItem>
                        <ListItem>
                            <ListItemIcon>
                                <RiPhoneLine />
                            </ListItemIcon>
                            <ListItemText primary={userSelected.numTelefono} />
                        </ListItem>
                        <ListItem>
                            <ListItemIcon>
                                <RiMailLine />
                        ...
                        <ListItem>
                            ...
                            <ListItemText primary={userSelected.role} />
                        </ListItem>
                        <ListItem>
                            <ListItemIcon>
                                <RiCalendarEventLine />
                            </ListItemIcon>
                            <ListItemText primary={userSelected.createdAt} />
                        </ListItem>
                    </List>
                </Grid>
                <Grid item>
