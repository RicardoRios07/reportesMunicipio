...
const colors = {
	gradients: {
		...
		red1: 'linear-gradient(to right, #333333, #dd1818)'
	},
	shadows: {
		success:
...
export const DarkTheme = createTheme({
	...
	sidebar: {
		...
		boxShadow: `1px 0 0 ${colors.layout.sidebar.dividerBg}`,
		width: '230px',
		widthClose: '85px',
		paddingTop: '45px'
	},
	header: {
		...
		boxShadow: `0px 1px 0px ${colors.layout.sidebar.dividerBg}`,
		...
		MuiCssBaseline: {
			styleOverrides: {
				...
				'.leaflet-popup-content-wrapper': {
					background: `${colors.layout.general.bodyBg}!important`,
					color: `${colors.alpha.black[100]}!important`
				},
				'.leaflet-popup-tip': {
					background: `${colors.layout.general.bodyBg}!important`
				},
